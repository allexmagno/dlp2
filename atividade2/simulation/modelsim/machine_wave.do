...
add wave -noupdate -expand -group entrada_ctrl /machine/rst
add wave -noupdate -expand -group entrada_ctrl /machine/load
add wave -noupdate -expand -group entrada_ctrl /machine/button
add wave -noupdate -expand -group entrada_ctrl /machine/enable
